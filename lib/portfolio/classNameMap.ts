export const ctaBtnClassMap = {
  base: "box-border flex items-center gap-3 border px-4 py-2 text-lg transition-all active:scale-[0.8] md:active:scale-none backdrop-blur-md",
  active: "border-green-300 bg-green-100/30 text-green-500 hover:bg-green-200/50 active:bg-green-300/30 font-bold",
  inactive:
