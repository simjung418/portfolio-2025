  ...
  platform: {
    ...
    detail: {
      challenge: (
        <>
          <p>
            복잡한 내부 관리 (회계, 인사, PM) 프로세스 및 외부 사용자 인터페이스 (고객, 번역사) 통합을 포함한 핵심
            플랫폼의 지속적 개선 및 외부 의존도 제거가 필요했습니다. 내부 직원들이 복잡한 실제 워크플로우를 시스템
            내에서 원활하게 처리할 수 있도록 다각적인 기능을 구현해야 했습니다.
          </p>
        </>
      ),
      action: (
        <>
          <p>
            퍼블리셔로 시작하여 Vue.js, PHP, MySQL 풀스택 개발자로 성장했습니다. 50여개 메뉴에 걸친 핵심 기능을
            주도적으로 개발하고, 외부 협력사 의존도를 100% 제거했습니다.
          </p>
        </>
      ),
      result: (
